# nohup python3 train.py --seed 10 --result --device 1 --torchQAT --savename "./result/random/TorchQAT_mobilenetv2_cifar10_10.pt" 1>/dev/null 2> err.txt & 
# nohup python3 train.py --seed 20 --result --device 1 --torchQAT --savename "./result/random/TorchQAT_mobilenetv2_cifar10_20.pt" 1>/dev/null 2> err.txt & 
# nohup python3 train.py --seed 30 --result --device 1 --torchQAT --savename "./result/random/TorchQAT_mobilenetv2_cifar10_30.pt" 1>/dev/null 2> err.txt & 
